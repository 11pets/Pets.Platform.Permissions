...
using Pets.Platform.Permissions.EFCore.Extensions;

namespace Pets.Platform.Permissions.EFCore.Persistence
{
    public partial class PermissionsDbContext : DbContext, IUnitOfWork
    {
        ...
        public PermissionsDbContext(DbContextOptions<PermissionsDbContext> options, IMediator mediator)
            : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.EnforceUtcDateTime();
        }
